...
export default {
  sidebar: {
    projects: "Proyectos EAA",
    pages: "Páginas",
    new_work_item: "Nuevo Producto",
    home: "Inicio",
    ...
    views: "Vistas",
    analytics: "Análisis",
    work_items: "Productos",
    cycles: "Fases (PEP)",
    modules: "Edificios / Naves",
    intake: "Entrada",
    drafts: "Borradores",
    favorites: "Favoritos",
    pro: "Pro",
  ...
  add_work_item: "Agregar Producto",
  advanced_description_placeholder: "Presiona '/' para comandos",
  create_work_item: "Crear Producto",
  ...
  common: {
    states: "Estatus Operativos",
    state: "Estatus Operativo",
    state_groups: "Grupos de Estatus",
    state_group: "Grupo de Estatus",
    priorities: "Prioridades",
    priority: "Prioridad",
    team_project: "Proyecto de equipo",
    project: "Proyecto EAA",
    cycle: "Fase",
    cycles: "Fases (PEP)",
    module: "Edificio / Nave",
    modules: "Edificios / Naves",
    labels: "Etiquetas",
    label: "Etiqueta",
    assignees: "Asignados",
    ...
    work_item: "Producto",
    work_items: "Productos",
    sub_work_item: "Etapa de Ingeniería",
    add: "Agregar",
    warning: "Advertencia",
    updating: "Actualizando",
    adding: "Agregando",
  ...
  project_settings: {
    ...
    features: {
      ...
      modules: {
        title: "Edificios / Naves",
        short_title: "Edificios",
  ...
  project_cycles: {
    add_cycle: "Agregar Fase",
    more_details: "Más detalles",
    cycle: "Fase",
    update_cycle: "Actualizar ciclo",
    create_cycle: "Crear Fase",
